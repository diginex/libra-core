...
const VMVerificationErrorKind$json = const {
  ...
  '2': const [
    ...
    const {'1': 'RangeOutOfBounds', '2': 2},
    const {'1': 'InvalidSignatureToken', '2': 3},
    const {'1': 'InvalidFieldDefReference', '2': 4},
    const {'1': 'RecursiveStructDefinition', '2': 5},
    const {'1': 'InvalidResourceField', '2': 6},
    const {'1': 'InvalidFallThrough', '2': 7},
    const {'1': 'JoinFailure', '2': 8},
    const {'1': 'NegativeStackSizeWithinBlock', '2': 9},
    const {'1': 'UnbalancedStack', '2': 10},
    const {'1': 'InvalidMainFunctionSignature', '2': 11},
    const {'1': 'DuplicateElement', '2': 12},
    const {'1': 'InvalidModuleHandle', '2': 13},
    const {'1': 'UnimplementedHandle', '2': 14},
    const {'1': 'InconsistentFields', '2': 15},
    const {'1': 'UnusedFields', '2': 16},
    const {'1': 'LookupFailed', '2': 17},
    const {'1': 'VisibilityMismatch', '2': 18},
    const {'1': 'TypeResolutionFailure', '2': 19},
    const {'1': 'TypeMismatch', '2': 20},
    const {'1': 'MissingDependency', '2': 21},
    const {'1': 'PopReferenceError', '2': 22},
    const {'1': 'PopResourceError', '2': 23},
    const {'1': 'ReleaseRefTypeMismatchError', '2': 24},
    const {'1': 'BrTypeMismatchError', '2': 25},
    const {'1': 'AssertTypeMismatchError', '2': 26},
    const {'1': 'StLocTypeMismatchError', '2': 27},
    const {'1': 'StLocUnsafeToDestroyError', '2': 28},
    const {'1': 'RetUnsafeToDestroyError', '2': 29},
    const {'1': 'RetTypeMismatchError', '2': 30},
    const {'1': 'FreezeRefTypeMismatchError', '2': 31},
    const {'1': 'FreezeRefExistsMutableBorrowError', '2': 32},
    const {'1': 'BorrowFieldTypeMismatchError', '2': 33},
    const {'1': 'BorrowFieldBadFieldError', '2': 34},
    const {'1': 'BorrowFieldExistsMutableBorrowError', '2': 35},
    const {'1': 'CopyLocUnavailableError', '2': 36},
    const {'1': 'CopyLocResourceError', '2': 37},
    const {'1': 'CopyLocExistsBorrowError', '2': 38},
    const {'1': 'MoveLocUnavailableError', '2': 39},
    const {'1': 'MoveLocExistsBorrowError', '2': 40},
    const {'1': 'BorrowLocReferenceError', '2': 41},
    const {'1': 'BorrowLocUnavailableError', '2': 42},
    const {'1': 'BorrowLocExistsBorrowError', '2': 43},
    const {'1': 'CallTypeMismatchError', '2': 44},
    const {'1': 'CallBorrowedMutableReferenceError', '2': 45},
    const {'1': 'PackTypeMismatchError', '2': 46},
    const {'1': 'UnpackTypeMismatchError', '2': 47},
    const {'1': 'ReadRefTypeMismatchError', '2': 48},
    const {'1': 'ReadRefResourceError', '2': 49},
    const {'1': 'ReadRefExistsMutableBorrowError', '2': 50},
    const {'1': 'WriteRefTypeMismatchError', '2': 51},
    const {'1': 'WriteRefResourceError', '2': 52},
    const {'1': 'WriteRefExistsBorrowError', '2': 53},
    const {'1': 'WriteRefNoMutableReferenceError', '2': 54},
    const {'1': 'IntegerOpTypeMismatchError', '2': 55},
    const {'1': 'BooleanOpTypeMismatchError', '2': 56},
    const {'1': 'EqualityOpTypeMismatchError', '2': 57},
    const {'1': 'ExistsResourceTypeMismatchError', '2': 58},
    const {'1': 'BorrowGlobalTypeMismatchError', '2': 59},
    const {'1': 'BorrowGlobalNoResourceError', '2': 60},
    const {'1': 'MoveFromTypeMismatchError', '2': 61},
    const {'1': 'MoveFromNoResourceError', '2': 62},
    const {'1': 'MoveToSenderTypeMismatchError', '2': 63},
    const {'1': 'MoveToSenderNoResourceError', '2': 64},
    const {'1': 'CreateAccountTypeMismatchError', '2': 65},
    const {'1': 'ModuleAddressDoesNotMatchSender', '2': 66},
    const {'1': 'NoModuleHandles', '2': 67},
  ],
};
...
const AssertionFailure$json = const {
  '1': 'AssertionFailure',
  '2': const [
    const {
      '1': 'assertion_error_code',
      '3': 1,
      '4': 1,
      '5': 4,
      '8': const {'6': 1},
      '10': 'assertionErrorCode',
    },
  ],
};
...
const ExecutionStatus$json = const {
  ...
  '2': const [
    ...
    const {'1': 'assertion_failure', '3': 2, '4': 1, '5': 11, '6': '.types.AssertionFailure', '9': 0, '10': 'assertionFailure'},
